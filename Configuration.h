...
#define STRING_CONFIG_H_AUTHOR "(Alexander)" // Who made the changes.
...
#define TEMP_SENSOR_0 13 //13 Hotend
#define TEMP_SENSOR_1 -1 //-1 Heatbed
...
// Ultimaker
    #define  DEFAULT_Kp 39.03 //22.2
    #define  DEFAULT_Ki 6.73 //1.08
    #define  DEFAULT_Kd 56.62 //114
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 69.24 //10.00
    #define  DEFAULT_bedKi 7.61 //.023
    #define  DEFAULT_bedKd 157.40 // 305.4
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,160,300}  // default steps per unit for Ultimaker
...
#define PLA_PREHEAT_HPB_TEMP 50 //70
